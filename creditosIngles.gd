...
# Cambia la escena a la de ajustes de sonido en inglés.
func _on_sounds_button_pressed():
	get_tree().change_scene_to_file("res://menu/sounds_ingles.tscn")


# Función que se llama cuando la canción de créditos termina.
# Reinicia la canción y aplica el efecto de fade-in nuevamente.
