...
func _on_creditos_button_pressed():
	get_tree().change_scene_to_file("res://creditos.tscn")  # Cambia a la escena de créditos
...
func _on_sounds_button_pressed():
	get_tree().change_scene_to_file("res://menu/sounds_español.tscn")  # Cambia a la escena de ajustes de sonido en español
...
func _on_label_level_20_pressed():
	if not $LabelLevel20.disabled:  # Verifica si el botón de nivel 20 está habilitado
		get_tree().change_scene_to_file("res://main/main20español.tscn")  # Cambia a la escena del nivel 20


func _on_label_level_40_pressed():
	if not $LabelLevel40.disabled:  # Verifica si el botón de nivel 40 está habilitado
		get_tree().change_scene_to_file("res://main/main40español.tscn")  # Cambia a la escena del nivel 40

func _on_label_level_60_pressed():
	if not $LabelLevel60.disabled:  # Verifica si el botón de nivel 60 está habilitado
		get_tree().change_scene_to_file("res://main/main60español.tscn")  # Cambia a la escena del nivel 60

func _on_label_level_80_pressed():
	if not $LabelLevel80.disabled:  # Verifica si el botón de nivel 80 está habilitado
		get_tree().change_scene_to_file("res://main/main80español.tscn")  # Cambia a la escena del nivel 80

func _on_label_level_100_pressed():
	if not $LabelLevel100.disabled:  # Verifica si el botón de nivel 100 está habilitado
		get_tree().change_scene_to_file("res://main/main100español.tscn")  # Cambia a la escena del nivel 100
